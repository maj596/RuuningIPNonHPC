...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # paras1
        parser.add_argument('--dataroot', default='/scratch/maj596/IPN-OCTA-Segmentation/smaller', help='path to data')
        ...
        # paras2
        parser.add_argument('--saveroot', default='/scratch/maj596/github/newipn/2023logs', help='path to save results')
